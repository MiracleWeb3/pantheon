...
> *pantheon-native name — this skill ships as `ponytail-review` in its source (see CREDITS.md for attribution).*
...
self-check is the spartan minimum, not bloat, never flag it for deletion.
Does not apply the fixes, only lists them.
"stop spartan-review" or "normal mode": revert to verbose review style.
