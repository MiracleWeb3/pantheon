---
name: vue-philosophy-eslint-config
description: Configuring @vue-philosophy/eslint-config for framework support, formatters, and rule overrides. Use when adding React/Vue/Svelte/Astro support, customizing rules, or setting up VS Code integration.
---

# @vue-philosophy/eslint-config
...
export default vue-philosophy(
  {
    // First argument: vue-philosophy config options
  },
...
export default vue-philosophy()
  ...
  .override('vue-philosophy/stylistic/rules', {
    rules: {
...
<!-- 
Source references:
- https://github.com/vue-philosophy/eslint-config
- https://raw.githubusercontent.com/vue-philosophy/eslint-config/refs/heads/main/README.md
-->
