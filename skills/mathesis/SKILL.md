...
# mathesis — extract a skill from what just happened

> Deprecated compatibility alias: use `/pantheon:hephaestus-session` for new skill extraction workflows. This file remains for internal implementation/history and compatibility.
