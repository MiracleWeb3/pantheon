...
description: Production-ready CSS transitions for web apps -- notification badges, dropdowns, modals, panel reveals, card resizes, number pop-ins, text swaps, icon swaps, success checks, avatar group hovers, error shakes. Triggers "add a transition", "animate the dropdown", "hover lift".
---
