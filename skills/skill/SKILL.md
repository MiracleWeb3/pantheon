...
- `/pantheon:skill list` - Show detailed skill inventory
- `/pantheon:skill add` - Start skill creation (invoke skillify)
- `/pantheon:skill scan` - Scan both skill directories
...
- `/pantheon:forge-session` - Extract a skill from current conversation (`/pantheon:learner` is a deprecated alias)
...
- Run `/pantheon:skill list` periodically to review your skill library
