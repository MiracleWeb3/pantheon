---
name: ui-ux-pro-max
description: "UI/UX design intelligence: styles, color palettes, product types, UX guidelines, chart types across React, Vue, SwiftUI, Tailwind. Use to plan, design, build, or review UI/UX components (button, modal, form), styles (glassmorphism, brutalism, dark mode), or projects (dashboard, SaaS)."
---
