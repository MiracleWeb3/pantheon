...
# socrates — ask, and get an answer worth acting on
...
```bash
/pantheon:socrates <claude|codex|gemini|antigravity|grok|cursor> <question or task>
```

Examples:

```bash
/pantheon:socrates codex "review this patch from a security perspective"
/pantheon:socrates gemini "suggest UX improvements for this flow"
/pantheon:socrates antigravity "suggest UX improvements for this flow"
/pantheon:socrates claude "draft an implementation plan for issue #123"
/pantheon:socrates cursor "apply this implementation plan"
```
