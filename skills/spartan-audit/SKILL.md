...
> *pantheon-native name — this skill ships as `ponytail-audit` in its source (see CREDITS.md for attribution).*

spartan-review, repo-wide. Scan the whole tree instead of a diff. Rank
findings biggest cut first.

## Tags

Same as spartan-review:
...
"stop spartan-audit" or "normal mode" to revert.
