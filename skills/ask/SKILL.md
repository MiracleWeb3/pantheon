...
```bash
/pantheon:ask <claude|codex|gemini|antigravity|grok|cursor> <question or task>
```

Examples:

```bash
/pantheon:ask codex "review this patch from a security perspective"
/pantheon:ask gemini "suggest UX improvements for this flow"
/pantheon:ask antigravity "suggest UX improvements for this flow"
/pantheon:ask claude "draft an implementation plan for issue #123"
/pantheon:ask cursor "apply this implementation plan"
```
