...
Using `EventBusKey` is the key to bind the event type to the key, similar to Vue's [`InjectionKey`](https://vue-philosophy.me/posts/typed-provide-and-inject-in-vue) util.
