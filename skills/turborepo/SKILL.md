---
name: turborepo
description: "Turborepo monorepo build system guidance. Triggers: turbo.json, task pipelines, dependsOn, caching, remote cache, the turbo CLI, --filter, --affected, monorepo structure/boundaries. Use when configuring tasks/pipelines, creating packages, setting up a monorepo, or debugging cache."
metadata:
