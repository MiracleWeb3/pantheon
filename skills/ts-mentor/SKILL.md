...
> *pantheon-native name — this skill ships as `ask-matt` in its source (see CREDITS.md for attribution).*
...
**`/ts-mentor-setup`** — run before your first engineering flow to configure the issue tracker, triage labels, and doc layout the other skills assume. Custom issue trackers also work.
