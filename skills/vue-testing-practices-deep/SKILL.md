---
name: vue-testing-practices-deep
version: 1.0.0
license: MIT
...
> *pantheon-native name — this skill ships as `vuejs-ai-vue-testing-best-practices` in its source (see CREDITS.md for attribution).*
