---
name: shadcn
description: Manages shadcn components and projects -- adding, searching, fixing, styling, and composing UI. Provides project context, component docs, and usage examples. Applies when working with shadcn/ui, component registries, presets, or a components.json file. Triggers "shadcn init".
