---
name: vue-router-practices-deep
...
> *pantheon-native name — this skill ships as `vuejs-ai-vue-router-best-practices` in its source (see CREDITS.md for attribution).*
