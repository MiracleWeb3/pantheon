---
name: impeccable
description: "Use to design, redesign, critique, audit, or polish a frontend interface: websites, dashboards, product UI, components, forms. Handles UX review, hierarchy, accessibility, design tokens. Also for bland designs needing boldness or live UI iteration. Not for backend-only or non-UI tasks."
